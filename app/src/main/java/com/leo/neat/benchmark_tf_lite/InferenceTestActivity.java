...
public class InferenceTestActivity extends AppCompatActivity {
     ...
     */
    private static final String TAG = "InferenceTestActivity";
    ...
    private void setUpCameraOutputs(int width, int height) {
        ...
        try {
            for (String cameraId : manager.getCameraIdList()) {
                ...
                // coordinate.
                int displayRotation = getWM().getDefaultDisplay().getRotation();
                ...
                getWM().getDefaultDisplay().getSize(displaySize);
